...
function TimelineItem({year, title, classes, description}){
    return (
        <ol className= 'flex flex-col md-flex-row relative border-1 border-stone-200'>
            <li className= "mb=10 ml-4">
                ...
                <p className="flex flex-wrap gap-4 flex-row items-center justify-start text-xs md:text-sm">
                    <span className="inline-block px-2 py-1 font-semibold text-white bg-stone-900 rounded-md bg-gradient-to-r from-teal-500 to-cyan-900">
                        {year}
                    </span>
